...
export enum OPS_DEMANDE_TYPE {
  ...
  MATOMO = "Ajout d'un site ou membre à Matomo",
  SENTRY = "Ajout d'une team ou membre à Sentry",
...
export const OPS_DEMANDE_FIELDS: Record<OPS_DEMANDE_TYPE, OpsFieldKey[]> = {
  ...
  [OPS_DEMANDE_TYPE.MATOMO]: ["urlSite", "emailAssocier", "commentaires"],
  [OPS_DEMANDE_TYPE.SENTRY]: ["urlSite", "emailAssocier", "commentaires"],
  [OPS_DEMANDE_TYPE.UPDOWN]: [
    "urlSurveiller",
    "emailsNotifier",
    "commentaires",

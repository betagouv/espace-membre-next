...
export const EMAIL_STATUS_READABLE_FORMAT: Record<EmailStatusCode, string> = {
    EMAIL_ACTIVE: "Actif",
    EMAIL_ACTIVE_AND_PASSWORD_DEFINITION_PENDING: "Actif : en attente de définition du mot de passe",
    ...
    [EmailStatusCode.EMAIL_REDIRECTION_PENDING]: "L'email est une redirection. La création est en cours",
    ...
    [EmailStatusCode.EMAIL_TICKET_CREATION_PENDING]: "Email en attente de création par la team ops",
    [EmailStatusCode.EMAIL_TICKET_RECREATION_PENDING]: "Email en attente de recréation par la team ops"
};

...
export const requiredError = function (
    field: string,
    callback: ValidatorCalback
) {
    callback(field, "Le champ n‘est pas renseigné");
};

export const isValidDate = function (
    field: string,
    date: Date,
    callback: ValidatorCalback
) {
...
export const shouldBeOnlyUsername = function (
    field: string,
    value: string,
    callback: ValidatorCalback
) {
    ...
    callback(
        field,
        'La valeur doit être le nom du membre seul et ne doit pas être l‘URL du membre ni commencer avec "@"'
    );
    return null;
};

export const isValidEmail = function (
    field: string,
    email: string,
    callback: ValidatorCalback
) {
...
export const isValidDomain = function (
    field: string,
    domain: string,
    callback: ValidatorCalback
) {

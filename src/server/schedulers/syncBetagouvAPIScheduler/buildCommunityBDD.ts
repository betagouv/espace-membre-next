...
// export const communityBdd = async (users: memberSchemaType[] = []) => {
...
//                 result["employer"][mission["status"]].push({
//                     date: startDate,
//                     increment: 1,
//                 });
//                 result["domaineOverDate"][convert(user.domaine)].push({
//                     date: startDate,
//                     increment: 1,
//                 });
//                 result["gender"][convert(user.gender)].push({
//                     date: startDate,
//                     increment: 1,
//                 });
//             }
...
//     const TYPES = [...employerTypes, ...genderTypes, ...domaineTypes];
//     /**
...
//                 event.date = formatDateToISOString(
...
//                 dataByDate[event.date] =
//                     dataByDate[event.date] ||
//                     createDefaultObjectWithKeysAndValue(TYPES, 0);
...
//     for (const type of [...employerTypes, ...genderTypes, ...domaineTypes]) {

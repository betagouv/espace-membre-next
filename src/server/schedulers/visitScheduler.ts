...
//         (visitInfo) =>
//             getUserInfoForUsername(usersInfos, visitInfo.referent).primary_email
//     );
...
//     console.log(
//         "Demarrage du cron job pour l'envoie du message à l'accueil Ségur"
//     );
...
//         referent: getUserInfoForUsername(usersInfos, visitInfo.referent)
//             .fullname,
//     }));

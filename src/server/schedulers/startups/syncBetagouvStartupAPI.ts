...
// import { Incubators, Startups } from "@/@types/db";
// import { getLastCommitFromFile } from "@/lib/github";
// import { db } from "@/lib/kysely";
// import { githubIncubatorSchemaType } from "@/models/incubator";
...
//     incubators: Omit<githubIncubatorSchemaType>[],
//     startup: StartupInfo
// ) {
//     try {
...
//         );
//         if (incubator) {
//             const existingIncubator = await db
//                 .selectFrom("incubators")
//                 .selectAll()
//                 .where("ghid", "=", incubator.id)
//                 .executeTakeFirst();

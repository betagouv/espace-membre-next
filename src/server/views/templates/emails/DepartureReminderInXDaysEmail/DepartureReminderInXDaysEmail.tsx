    ...
    return (
        <StandardLayout title={title}>
            <MjmlText>
                ...
                <p>
                    Ta date de fin de mission est indiquée le {leavingDate},
                    dans {days} jours.
                </p>

                <p>
                    Si cette date a changé, mets-la à jour pour rester membre de
                    la communauté. C'est important car elle permet de conserver
                    tes accès aux différents services : Mattermost, emails, ...
                </p>
                <p>
                    En général, ta nouvelle date de fin doit correspondre à la
                    date du prochain comité d'investissement de ton produit
                    (dans 6 mois maximum).
                </p>
                <p>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="https://doc.incubateur.net/communaute/travailler-a-beta-gouv/jutilise-les-outils-de-la-communaute/outils/mise-a-jour-de-mes-informations">
                                suivre les autres méthodes de modification de ta
                                fiche
                            </a>
                        </li>
                    </ul>
                ...
                <p>
                    Si tu n'y arrives pas, un membre de ton équipe pourra sans
                    doute t'aider. Sinon, n'hésite pas à poser tes questions sur
                    Mattermost dans{" "}
                ...
                {jobs.length > 0 && (
                    <>
                        <p>
                            Si ta mission se termine, voici quelques offres
                            actuellement ouvertes qui pourraient correspondre à
                            ton domaine :
                        </p>
                        <ul>
                            {jobs.map((job, i) => (
                ...
                {jobs.length === 0 && (
                    <p>
                        Si ta mission se termine, tu peux retrouver toutes les
                        offres sur :{" "}
                        <a href="https://www.welcometothejungle.com/fr/companies/communaute-beta-gouv">
                            Welcome to the Jungle
                        </a>
                ...
                <ul>
                    <li>
                        En contactant directement l'équipe qui te fait rêver
                    </li>
                    <li>

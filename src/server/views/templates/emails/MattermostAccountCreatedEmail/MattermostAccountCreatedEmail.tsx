...
export function MattermostAccountCreatedEmail({
  ...
  return (
    <StandardLayout title={title}>
      ...
      <MjmlText>
        Il faut maintenant que tu définisses ton mot de passe. Pour ce faire,
        suis la procédure de réinitialisation de mot de passe en cliquant sur le
        bouton suivant :
      </MjmlText>
      <MjmlButton href={resetPasswordLink}>Définir mon password</MjmlButton>
      <MjmlText>
        Si le bouton ne fonctionne pas, tu peux utiliser ce lien :<br />
        <a href={resetPasswordLink}>{resetPasswordLink}</a>
      </MjmlText>
      <MjmlText>
        Une fois connecté·e, n'oublie pas d'ajouter un rôle et une image à ton
        profil Mattermost pour rendre les échanges plus faciles.
      </MjmlText>
      <MjmlText>

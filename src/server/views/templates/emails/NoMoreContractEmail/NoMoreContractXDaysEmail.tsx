        ...
        <StandardLayout title={title}>
            <MjmlText>
                ...
                <p>
                    ...
                    chez beta.gouv.fr a été créée ou mise à jour, ta date de fin
                    de mission a été définie pour le{" "}
                    <strong>{`${latestMission.end ? format(latestMission.end, "d MMMM", { locale: fr }) : ""}`}</strong>
                    .{" "}
                    {days === 1
                        ? `Cette date était hier`
                        : `C'était il y a 30 jours`}{" "}
                    ! Tes différents comptes relatifs à la communauté seront
                    bientôt supprimés ou désactivés.
                </p>

                <p>
                    Si la date est incorrecte (tu l’avais peut-être mise sans
                    avoir d’info sur la date réelle de fin, ou alors la date de
                    fin a été revue),{" "}
                ...
                <ul>
                    ...
                    <li>
                        ...
                        être actif ou changer l'adresse email de ton compte
                        (l'adresse beta.gouv.fr va être supprimée)
                    </li>
                </ul>
                ...
                <p>
                    On espère que tu as passé un moment positif avec nous ! Si
                    tu as des questions, n'hésite pas à les poser en répondant à
                    cet email.
                </p>
            </MjmlText>
        </StandardLayout>

        ...
        <StandardLayout title={title}>
            <MjmlText>
                ...
                <ul>
                    ...
                    <li>
                        Étape 2 : Definis ton mot de passe pour ton adresse
                        @beta.gouv.fr{" "}
                    ...
                    <li>
                        Etape 3 : Connecte toi à ta boite email @beta.gouv.fr
                        sur le <a href={emailUrl}>Webmail</a>. Si tu souhaites
                        utiliser un autre outil (Gmail, Outlook, …) tu peux le
                        faire en suivant{" "}
                ...
                <p>
                    Ton compte Mattermost (l'outil de discussion de la
                    communauté) va être automatiquement créé d'ici 10 à 15 mins,
                    tu recevras sur {email} les instructions pour y accéder.
                </p>

                <p>
                    Dans les prochains jours tu recevras un email pour te
                    présenter les prochaines étapes de ton embarquement au sein
                    de la communauté.
                </p>

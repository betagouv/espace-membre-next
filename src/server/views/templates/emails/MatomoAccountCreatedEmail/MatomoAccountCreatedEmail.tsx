    ...
    return (
        <StandardLayout title={title}>
            <MjmlText>
                ...
                <p>
                    Ton compte matomo vient d'être créé avec l'adresse {email}.
                </p>
                <p>
                    Tu peux définir ton mot de passe en faisant une
                    réinitialisation de mot de passe en cliquant sur le bouton
                    ci-dessous, puis sur "Lost your password?".
                </p>
            </MjmlText>

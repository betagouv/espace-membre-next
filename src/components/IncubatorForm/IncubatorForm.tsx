  ...
  return (
    (fieldShape && (
      <Input
        ...
        {...nativeProps}
        state={
          errors && errors.incubator && errors.incubator[id]
            ? "error"
            : "default"
        }
        stateRelatedMessage={
        ...
        >
          ...
          <div
            className={`fr-input-group ${
              errors?.incubator && errors?.incubator.short_description
          ...
          >
            ...
            <ClientOnly>
              <MdEditor
                ...
                onChange={(data, e) => {
                  setValue("incubator.short_description", data.text, {
                    shouldValidate: true,
                    shouldDirty: true,
                  });
                }}
          ...
          >
            ...
            <ClientOnly>
              <MdEditor
                ...
                defaultValue={
                  props.incubator?.description || DEFAULT_DESCRIPTION
                }
                style={{
                  height: "500px",
                  marginTop: "0.5rem",
                ...
                renderHTML={(text) => mdParser.render(text)}
                onChange={(data, e) => {
                  setValue("incubator.description", data.text, {
                    shouldValidate: true,
                    shouldDirty: true,
                  });
                }}
          ...
          <SESponsorSelect
            ...
            hint={"Indiquez l'administration qui porte cet incubateur"}
            state={errors.incubator && errors.incubator.owner_id && "error"}
            stateMessageRelated={
              errors.incubator &&

          ...
          <div>
            ...
            {currentNewsletter.publish_at && (
              <p>
                ...
                {format(currentNewsletter.publish_at, "dd/MM/yyyy à HH:mm")}
              </p>
            )}
            ...
            <p>
              ...
              <a
                href={currentNewsletter.brevo_url || currentNewsletter.url}
                target="_blank"
                title={
                  (currentNewsletter.publish_at &&
              ...
              >
                {currentNewsletter.brevo_url || currentNewsletter.url}
              </a>
            </p>
            <p>
              L'infolettre est mise en forme par l'équipe d'animation (chaque
              mardi matin) sur la base des contenus proposés par la communauté
              sur le pad, puis envoyée le mardi à 17h.
            </p>
          </div>
        )}

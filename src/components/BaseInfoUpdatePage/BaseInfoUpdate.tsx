  ...
  return (
    <>
      <div className={fr.cx("fr-mb-5w")}>
        ...
        <p>Ces informations seront publiées sur le site beta.gouv.fr.</p>
        ...
        >
          <Input
            label={memberSchema.shape.fullname.description + " (obligatoire)"}
            nativeInputProps={{
          ...
          />
          <Input
            label={memberSchema.shape.role.description + " (obligatoire)"}
            nativeInputProps={{
          ...
          <br />
          <br />
          <h2> {isCurrentUser ? `Mes compétences` : `Compétences`}</h2>
          {isCurrentUser && (
            <label className="fr-label fr-mb-3w" htmlFor="competence-editor">
              Aide les membres de la communauté à mieux t'identifier en cas de
              besoin
            </label>
          )}
          <CompetencesEditor
          ...
          <p>
            ...
            . Elles sont confidentielles et anonymisées mis à part le lieu de
            travail.
          </p>
          <GenderSelect
            label="Genre"
          ...
          <Select
            ...
            state={errors.member?.legal_status ? "error" : "default"}
            stateRelatedMessage={errors.member?.legal_status?.message}
          >
          ...
          <Input
            ...
            state={errors.member?.average_nb_of_days ? "error" : "default"}
            stateRelatedMessage={errors.member?.average_nb_of_days?.message}
          />
          <h2>
            {isCurrentUser
          ...
          <CitySelect
            ...
            state={errors.member?.workplace_insee_code ? "error" : "default"}
            stateRelatedMessage={errors.member?.workplace_insee_code?.message}
            defaultValue={defaultValues.member.workplace_insee_code || ""}
          />
          <Button

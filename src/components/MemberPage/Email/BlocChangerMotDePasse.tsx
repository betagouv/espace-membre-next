  ...
  const onSubmit = async (e) => {
    ...
    if (resp.success) {
      ...
      setAlertMessage({
        ...
        message: `Réessayer plus tard, si l'erreur persiste contacter espace-membre@beta.gouv.fr. Erreur : ${resp.message}`,
        type: "warning",
      });
    }
  };
      ...
      ]) || [
        {
          message: (
            <>
              ...
              <br />
              - des majuscules et des minuscules ainsi que des caractères
              spéciaux,
              <br />
              - pas de caractères spéciaux au début ou à la fin,
              <br />- ne doit pas contenir tout ou partie du nom de compte
              utilisateur
            </>
          ),
  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <Button
        ...
        children={
          isSaving ? `Changement du mot de passe...` : `Changer le mot de passe`
        }
      />
    </form>
  );
  ...
  return (
    ...
    >
      {canChangePassword ? (
        ...
        <p>
          Il faut mettre à jour votre date de fin de mission et merger la pull
          request avant de pouvoir changer votre mot de passe
        </p>
      ) : (
        <p>
          Sans compte email, vous n'avez pas la possibilité de changer de mot de
          passe.
        </p>
      )}
    </Accordion>

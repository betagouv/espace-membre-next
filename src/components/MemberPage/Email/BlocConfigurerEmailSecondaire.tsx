...
export default function BlocConfigurerEmailSecondaire({
  ...
  return (
    <Accordion
      label={<span id="secondary-email">Configurer mon email secondaire</span>}
    >
      <p>
        L'email secondaire est utile pour récupérer son mot de passe ou garder
        contact après ton départ.
      </p>
      {canChangeEmails && (
        <>
          {!!alertMessage && (

        ...
        <>
          ...
          <form
            ...
            onSubmit={async (e) => {
              e.preventDefault();
              setIsSaving(true);
              const res = await safeUpdateCommunicationEmail(value);
              setIsSaving(false);
              if (res.success) {
                setAlertMessage({
              ...
              options={[
                {
                  label: primary_email,
                  nativeInputProps: {
                    defaultChecked: value === CommunicationEmailCode.PRIMARY,
                    onChange: () => setValue(CommunicationEmailCode.PRIMARY),
                  },
                },
                {
                  label: secondary_email,
                  nativeInputProps: {
                    defaultChecked: value === CommunicationEmailCode.SECONDARY,
                    onChange: () => setValue(CommunicationEmailCode.SECONDARY),
                  },
                },
              ]}
            />

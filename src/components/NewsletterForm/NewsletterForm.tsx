    ...
    <>
      <div>
        ...
        <h3>
          Infolettre du{" "}
          {format(
            newsletter.sent_at || getValues("publish_at") || new Date(),
            "d MMMM yyyy",
            { locale: dateFnsFr },
          )}
        </h3>
        ...
        >
          <Input
            ...
            stateRelatedMessage={errors && errors.brevo_url?.message}
          />
          {!newsletter.sent_at && (
            <Input
              ...
              nativeInputProps={{
                ...
                onChange: (e) => {
                  setValue("publish_at", new Date(e.target.value));
                },
              }}
              state={errors && errors.publish_at ? "error" : "default"}
              stateRelatedMessage={errors && errors.publish_at?.message}
            />
          )}
          <Button

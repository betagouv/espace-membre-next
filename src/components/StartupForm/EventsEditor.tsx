    ...
    <div className={fr.cx("fr-mb-3w")}>
      ...
      <Table
        ...
        data={eventsFields.map((event, index) => {
          const eventDateString = getValues(`startupEvents.${index}.date`)
          ...
          return [
            <Select
              key={event.id + "-name"}
              label={undefined}
              nativeSelectProps={register(`startupEvents.${index}.name`)}
              state={
                errors && errors[index]?.name?.message ? "error" : "default"
              }
              stateRelatedMessage={errors && errors[index]?.name?.message}
            >
            ...
            <Input
              ...
              state={
                errors && errors[index]?.date?.message ? "error" : "default"
              }
              stateRelatedMessage={errors && errors[index]?.date?.message}
            />,
            <Input
              label={null}
              ...
              state={
                errors && errors[index]?.comment?.message ? "error" : "default"
              }
              stateRelatedMessage={errors && errors[index]?.comment?.message}
            />,
            (index > 0 && (
              <button

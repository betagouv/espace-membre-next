...
export const Community = (props: CommunityProps) => {
  ...
  const [filters, setFilters] = useQueryState("filters", communityQueryParser);
      ...
      return (
        filters.filter((filter) => {
          if (!filter) {
            ...
            return user && user.competences?.includes(filter.value.toString());
  ...
  return (
    <>
      ...
      <label className="fr-label fr-mb-3w" htmlFor="search-member">
        Vous pouvez chercher des membres par nom, domaine, compétence, produit
        ou incubateur.
      </label>
      <AutoComplete
        id="search-member"
        ...
        options={[
          {
            ...
            nativeInputProps: {
              ...
              onChange: (e) => {
                ...
                setFilters((filters) => [
                  ...filters.filter((f) => f.type !== "active_only"),
                        ...
                        <div key={header}>
                          ...
                          {header === "Email" && (
                            <Button
                              ...
                              onClick={() =>
                                copyToClipboard(getColumnData(header))
                              }
                            >
                              copier
                            </Button>

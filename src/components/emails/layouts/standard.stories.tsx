...
import { commonEmailsParameters, withEmailRenderer } from "@sbook/email";
import { StoryHelperFactory } from "@sbook/helpers";
import { playFindEmailStructure } from "@sbook/testing";
import { StandardLayout } from "./StandardEmail";
    ...
    children: (
        <>
            ...
            {/* <MjmlText>
                <h1>Fuga quis qui</h1>
                <p>
                    Labore sint et. Porro non doloremque vel magnam eaque
                    adipisci. Sit sint ducimus magnam sint eaque cum laborum.
                </p>
                <p>
                    Corporis eius voluptatem aut voluptas laborum quo et itaque
                    consequuntur. Modi perspiciatis vel necessitatibus illum et.
                    Tempora ut sit qui.
                </p>
            </MjmlText>
            ...
            <MjmlText>
                <p>
                    In delectus harum sed harum molestias fugiat fugiat et quae.
                    Ratione atque nobis autem id saepe quia voluptatem ad
                    laborum. Nihil reprehenderit aperiam et est. Quia et
                    provident ex quaerat aliquid voluptatem vel.
                </p>
            </MjmlText> */}
        </>
    ),

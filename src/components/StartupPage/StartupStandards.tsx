...
const TableStandards = ({ data, headers }) => {
  return (
    <div className="fr-table startup-files-list-table" data-fr-js-table="true">
      <table
          ...
          {data.map((row, i) => {
            if (row[1] === null) {
              return (
                ...
                >
                  <td className={fr.cx("fr-text--md")} colSpan={headers.length}>
                    {row[0]}
                  </td>
                </tr>
              );
    ...
    <>
      ...
      <TableStandards
        ...
        data={[
          ...
          [
            "Suivi DashLord",
            <BooleanBadge key="badge" value={startupInfos.dashlord_url} />,
          ...
          [
            ...
            match(startupInfos.dsfr_status)
              .with("Le DSFR est implémenté", () => (
                <BooleanBadge key="badge" value={true} validText="Oui" />
              ))
              .with("Le DSFR est implémenté partiellement", () => (
                <BooleanBadge
                  key="badge"
                  value={true}
              ...
              .with("Service non soumis au DSFR", () => (
                <BooleanBadge key="badge" value={true} validText="Non soumis" />
              ))
              .otherwise(() => (
                <BooleanBadge key="badge" value={false} invalidText="Inconnu" />
              )),

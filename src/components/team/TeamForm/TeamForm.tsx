  ...
  return (
    (fieldShape && (
      <Input
        ...
        {...nativeProps}
        state={errors && errors.team && errors.team[id] ? "error" : "default"}
        stateRelatedMessage={errors && errors.team && errors.team[id]?.message}
        {...(props ? props : {})}
      />
  ...
  const onSubmit = (data: teamUpdateSchemaType, e) => {
    ...
    props
      ...
      .then((resp) => {
        setIsSaving(false);
        setAlertMessage({
          title: props.team ? `Mise à jour effectuée` : "Équipe créée",
          message: props.team ? (
            <>La modification sera visible en ligne d'ici 24 heures.</>
          ) : (
      ...
      <div>
        ...
        >
          ...
          >
            ...
            <ClientOnly>
              <MdEditor
                ...
                defaultValue={
                  getValues("team.mission") || DEFAULT_SHORT_DESCRIPTION
                }
                style={{
                  height: "160px",
                  marginTop: "0.5rem",
          ...
          <SEIncubateurSelect
            ...
            defaultValue={
              props.incubatorOptions.filter(
                (incubator) =>
                  incubator.value === getValues("team.incubator_id"),
              )[0]
            }
            label={"Incubateur"}
          ...
          <MemberSelect
            ...
            valueKey={"uuid"}
            defaultValue={(props.teamMembers || []).map((member) => ({

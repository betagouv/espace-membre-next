      ...
      <div>
        ...
        <div className="fr-grid-row fr-grid-row-gutters">
          <div className="fr-col-12 fr-col-md-6 fr-col-lg-6">
            {!props.createAccount && (
              <>
                <p>
                  ...
                  <b>{props.userEmail}.</b>
                  <br />
                  Tu dois le rattacher à un site enregistré sur matomo.
                </p>
              </>
            )}
            ...
            {!props.sites.length && (
              <p>
                Nous n'avons pas enregistré de site matomo existant pour les
                produits sur lesquels tu travailles actuellemment. Si pourtant
                des sites existent merci de nous le signaler en envoyant un
                message dans le chatbot crips présent sur cette page.
              </p>
            )}
            {!!props.sites.length && (
            ...
            <p>
              Si il n'existe pas encore de site pour le site que tu veux
              ajouter. Tu peux le créer
            </p>
            <Button
              linkProps={{

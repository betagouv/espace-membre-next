                    ...
                    {!connected && !loginSent && (
                        ...
                        >
                            <label htmlFor="emailInput">
                                <b>Ton email (@beta.gouv.fr ou secondaire)</b>
                            </label>
                            ...
                            <span>
                                <a href="#forgot">J'ai oublié mon email</a>
                            </span>
                        </form>
                    )}
                    {loginSent && !connected && (
        ...
        <>
            ...
            <div className="no-margin">
                ...
                <div className="form__group">
                    <label htmlFor="end">
                        <strong>Fin de la mission (obligatoire)</strong>
                        <br />
                        Si tu n'as pas la date exacte, mets une date dans 6
                        mois, c'est possible de la corriger plus tard.
                        <br />
                ...
                <div className="no-margin">
                    <div className="form__group  margin-10-0">
                        <label>
                            ...
                            <br />
                            Les informations de connexion seront envoyées à cet

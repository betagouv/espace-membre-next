          ...
          <div className="fr-col-12 fr-col-md-12 fr-col-lg-12">
            <div className="fr-container fr-background-alt--grey">
              <Alert
                ...
                description={
                  <>
                    <b>Vérifie les informations</b> de ton compte
                  </>
                }
              />
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="fr-fieldset__element fr-col-12 fr-mt-4w">
                        <h2 className="fr-h3">Mes compétences</h2>
                        <p>
                        ...
                        <CompetencesEditor
                          ...
                          defaultValue={member.competences || []}
                        />
                        <br />
                      </div>
                    </fieldset>
                    ...
                    >
                      ...
                      <div className="fr-fieldset__element">
                        <Mission
                          ...
                          errors={
                            errors.missions ? errors.missions[0] : undefined
                          }
                          index={0}
                    ...
                    >
                      <legend
                        ...
                        id="identity-fieldset-legend"
                      >
                        <h2 className="fr-h3">Sur l'annuaire</h2>
                      </legend>
                      <div className="fr-fieldset__element fr-col-12 fr-col-lg-8 fr-col-md-8">
                        <Input
                          textArea
                    ...
                    >
                      <legend
                        ...
                        id="identity-fieldset-legend"
                      >
                        <h2 className="fr-h3">Droits Github</h2>
                      </legend>
                      <div className="fr-fieldset__element">
                        <Input
                          label="Github"
                    ...
                    >
                      <legend
                        ...
                        id="identity-fieldset-legend"
                      >
                        <h2 className="fr-h3">Informations statistiques</h2>
                      </legend>
                      <div className="fr-fieldset__element">
                        <p className="fr-hint-text">
                          Ces informations servent uniquement à des fins
                          statistiques pour l'observatoire de la communauté.
                      ...
                      <div className="fr-col-12 fr-col-lg-6 fr-col-md-6">
                        ...
                        <div className="fr-fieldset__element ">
                          <Input
                            ...
                            state={
                              errors.average_nb_of_days ? "error" : "default"
                            }
                            stateRelatedMessage={
                              errors.average_nb_of_days?.message
                            }
                          />
                        </div>
                      </div>

...
export default async function Page() {
    ...
    return (
        <>
            ...
            <p>
                Une organisation sponsor dans le cadre du programme beta.gouv.fr
                est une entité publique qui soutient le développement d'un
                produit ou service numérique innovant. Cette organisation
                identifie un problème ou un besoin spécifique dans ses
                opérations ou pour ses usagers, et elle collabore avec une

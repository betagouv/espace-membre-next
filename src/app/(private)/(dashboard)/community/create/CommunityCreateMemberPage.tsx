            ...
            >
              ...
              >
                ...
                >
                  <Input
                    label={
                      createMemberSchemaShape.member.shape.firstname
                    ...
                    state={
                      errors.member && errors.member.firstname
                        ? "error"
                        : "default"
                    }
                    stateRelatedMessage={
                      errors.member && errors.member?.firstname?.message
                    }
                  />
                </div>
                <div
                ...
                >
                  <Input
                    label={
                      createMemberSchemaShape.member.shape.lastname
                        .description + " (obligatoire)"
                    }
                    nativeInputProps={{
                    ...
                    state={
                      errors.member && errors.member.lastname
                        ? "error"
                        : "default"
                    }
                    stateRelatedMessage={
                      errors.member && errors.member.lastname?.message
                    }
                  />
                </div>
                <div
                ...
                >
                  <Input
                    ...
                    state={
                      errors.member && errors.member.email ? "error" : "default"
                    }
                    stateRelatedMessage={
                      errors.member && errors.member.email?.message
                    }
                  />
                </div>
              </fieldset>
              ...
              >
                ...
                >
                  <Select
                    ...
                    state={
                      errors.member && errors.member.domaine
                        ? "error"
                        : "default"
                    }
                    stateRelatedMessage={
                      errors.member && errors.member.domaine?.message
                    }
                  >
                ...
                <div className="fr-fieldset__element">
                  <Mission
                    ...
                    errors={errors.missions ? errors.missions[0] : undefined}
                    index={0}
                    labels={{

...
describe("Pull requests watchers", () => {
    ...
    beforeEach((done) => {
        getPullRequestsStub = sinon.stub(github, "getPullRequests").returns(
            Promise.resolve({
                data: PRexamples,
                url: "",
            })
        );
        getPullRequestFilesStub = sinon
            .stub(github, "getPullRequestFiles")
            .returns(
                Promise.resolve({
                    data: [
                        {
                            ...
                            contents_url:
                                "https://api.github.com/repos/octocat/content/_authors/membre.actif.md",
                        },
                    ],
                })
            );
